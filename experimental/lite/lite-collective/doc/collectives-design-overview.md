...
| --- | --- | --- | --- | --- |
| AllGather | 1nx2g, 2nx1g, 2nx4g | Beats NCCL no-GDR at 1MiB: `84.57/83.64 us` vs `119.07/117.32 us`; full `128B-1GiB` sweep is correct | `<128KiB`: pipelined single-leader host-slab with direct QP slot flags; `>=128KiB`: NUMA-split host slabs using NIC0+NIC1 | [`native_collectives.cu:L1984-L2198`](../nccl/native_collectives.cu#L1984-L2198) ([VS Code](vscode://file/home/yangz/nfs/zhongjie/uccl.worktrees/copilot-collectives-support-table-implementation/experimental/lite/lite-collective/nccl/native_collectives.cu:1984:1)) |
