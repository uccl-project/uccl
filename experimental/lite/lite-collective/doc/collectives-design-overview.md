...
| --- | --- | --- | --- | --- |
| AllGather | 1nx4g CudaIpc ring, opt-in 1nx4g no-CudaIpc host path, 2nx1g, 2nx2g, 2nx4g, general multi-node host memory | 1nx4g CudaIpc `>=8MiB` beats NCCL by ~1.2x busbw at 32MiB-1GiB; opt-in 1nx4g host path beats SHM-only NCCL at 4MiB-1GiB; 2nx4g beats NCCL no-GDR at 1MiB: `85.74/85.37 us` vs `118.20/117.53 us` | Single-node default large messages use a CudaIpc ring; `MSCCLPP_NCCL_HOST_ALLGATHER=1` uses shared pinned host slabs without CudaIpc payload access; multi-node layouts use host-memory slab exchange; no multi-node P2P AllGather path | [`ag_intra.cu:L103-L1362`](../nccl/lite-allgather/ag_intra.cu#L103-L1362), [`ag_inter.cu:L858-L1329`](../nccl/lite-allgather/ag_inter.cu#L858-L1329) |
