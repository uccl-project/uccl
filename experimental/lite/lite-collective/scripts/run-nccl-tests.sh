...
REAL_NCCL_LIB=""
EXTRA_ARGS=()
NCCL_SOCKET_IFNAME="${NCCL_SOCKET_IFNAME:-eno8303}"
# Keep NCCL's buffer size near its normal default. A 1GiB default makes NCCL
# 2.29.7 crash in 2nx4g net transport setup before collective timing starts.
NCCL_BUFFSIZE="${NCCL_BUFFSIZE:-4194304}"
...
for env_name in \
  ...
  NCCL_DEBUG NCCL_DEBUG_SUBSYS NCCL_ALGO NCCL_PROTO NCCL_MIN_NCHANNELS \
  NCCL_MAX_NCHANNELS NCCL_P2P_LEVEL NCCL_P2P_NET_CHUNKSIZE \
  NCCL_NET_GDR_LEVEL NCCL_IB_DISABLE NCCL_P2P_DISABLE NCCL_SHM_DISABLE NCCL_BUFFSIZE \
  NCCL_CROSS_NIC NCCL_IB_MERGE_NICS NCCL_IB_QPS_PER_CONNECTION \
  NCCL_IB_SPLIT_DATA_ON_QPS NCCL_CUMEM_HOST_ENABLE \
  ...
  MSCCLPP_NCCL_LOCAL_P2P_FALLBACK MSCCLPP_NCCL_CUDAIPC_EVENT_SYNC \
  MSCCLPP_NCCL_HOST_ALLGATHER MSCCLPP_NCCL_HOST_ALLGATHER_CHUNK_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_MAP_SLAB \
  MSCCLPP_NCCL_AG_GPU_KERNEL MSCCLPP_NCCL_AG_GPU_STAGING \
  MSCCLPP_NCCL_HOST_ALLGATHER_SELF_KERNEL \
  MSCCLPP_NCCL_HOST_ALLGATHER_NUMA_PLACE \
  MSCCLPP_NCCL_HOST_ALLGATHER_MIN_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_KERNEL_MAX_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_KERNEL_THREADS \
  MSCCLPP_NCCL_HOST_ALLGATHER_COOP_MAX_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_TWO_KERNEL_MAX_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_TWO_KERNEL_BLOCK_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_COOP_MAX_BLOCKS \
  MSCCLPP_NCCL_HOST_ALLGATHER_REPLICATED_MIN_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_CALLBACK_READY_MIN_BYTES \
  MSCCLPP_NCCL_HOST_ALLGATHER_FULL_H2D_MAX_BYTES \
  MSCCLPP_AR_RSAG_COPY_ENGINE \
  MSCCLPP_NCCL_2RANK_RING_ALLREDUCE \
  MSCCLPP_NCCL_2RANK_RING_CHUNK_BYTES \
  MSCCLPP_NCCL_RS_CHUNK_BYTES MSCCLPP_NCCL_RS_IPC_EVENT_SYNC \
  MSCCLPP_NCCL_RS_LAYOUT_CHUNK_BYTES \
  MSCCLPP_NCCL_RS_ASYNC_FINAL_ADD MSCCLPP_NCCL_RS_LOCAL_LEAD_CHUNKS \
  MSCCLPP_NCCL_RS_SHORT_LOCAL_LEAD_CHUNKS MSCCLPP_NCCL_RS_LONG_LOCAL_LEAD_CHUNKS \
  MSCCLPP_NCCL_RS_LOCAL_GPU_FLAGS MSCCLPP_NCCL_RS_LOCAL_PARALLEL_COPY \
  MSCCLPP_NCCL_RS_LOCAL_DEVICE_FLAG_MAX_BYTES \
  MSCCLPP_NCCL_RS_LOCAL_RING MSCCLPP_NCCL_RS_LOCAL_RING_EVENTS \
  MSCCLPP_NCCL_RS_P2P_RING MSCCLPP_NCCL_RS_2N2G_HIER \
  MSCCLPP_NCCL_RS_DIRECT_PARTNER_COPY MSCCLPP_NCCL_RS_DIRECT_PARTNER_COPY_2D \
  MSCCLPP_NCCL_RS_DIRECT_CROSS_WRITE \
  MSCCLPP_NCCL_RS_HOST_READ_FINAL_ADD MSCCLPP_NCCL_RS_DIRECT_TARGET_REDUCE \
  MSCCLPP_NCCL_RS_DIRECT_TARGET_SCATTER_KERNEL MSCCLPP_NCCL_RS_SINGLE_ASYNC_COPY \
  MSCCLPP_NCCL_RS_SINGLE_SLOT_RING MSCCLPP_NCCL_RS_DEVICE_FLAG_SYNC \
  MSCCLPP_NCCL_RS_IPC_DEVICE_FLAGS \
  MSCCLPP_NCCL_RS_PAIR_CONNECTION_WRITE MSCCLPP_NCCL_RS_CPU_FINAL_ADD \
  MSCCLPP_NCCL_RS_TWO_RANK_MAPPED_HOST \
  MSCCLPP_NCCL_RS_TWO_RANK_SMALL_HOST_BYTES \
  MSCCLPP_NCCL_RS_MAPPED_SEND_FINAL_REDUCE \
  MSCCLPP_NCCL_RS_MAPPED_HOST_SINGLE_CHUNK \
  MSCCLPP_NCCL_RS_SPLIT_FINAL_REDUCE \
  MSCCLPP_NCCL_RS_PARALLEL_SPLIT_FINAL \
  MSCCLPP_NCCL_RS_EAGER_RDMA_POST \
  MSCCLPP_NCCL_RS_ROUND_ROBIN_HCA \
  MSCCLPP_NCCL_RS_SMALL_HOST_FULL_BYTES \
  MSCCLPP_NCCL_RS_NO_CUDAIPC \
  MSCCLPP_NCCL_RS_NO_CUDAIPC_CHUNK_BYTES \
  MSCCLPP_NCCL_RS_DISABLE_AVX512; do
