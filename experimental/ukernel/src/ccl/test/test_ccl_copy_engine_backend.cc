...
int main() {
  ...
  CCL::CopyEngineBackend ce_gather_backend(gather_buffers);
  CCL::CopyEngineBackend ce_reduce_backend(reduce_buffers);
  CCL::PersistentKernelBackend pk_reduce_backend(
