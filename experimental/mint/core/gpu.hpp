...
constexpr auto cudaStreamCaptureStatusInvalidated =
...
constexpr auto cudaDevAttrComputeCapabilityMajor =
    hipDeviceAttributeComputeCapabilityMajor;
constexpr auto cudaDevAttrComputeCapabilityMinor =
...
constexpr auto CU_MEM_ALLOC_GRANULARITY_MINIMUM =
    hipMemAllocationGranularityMinimum;
constexpr auto CU_MEMORYTYPE_DEVICE = hipMemoryTypeDevice;

constexpr auto CU_POINTER_ATTRIBUTE_MEMORY_TYPE =
    HIP_POINTER_ATTRIBUTE_MEMORY_TYPE;
constexpr auto CU_POINTER_ATTRIBUTE_DEVICE_ORDINAL =
...
#define cuMemGetAllocationGranularity(...) \
  hipMemGetAllocationGranularity(__VA_ARGS__)
