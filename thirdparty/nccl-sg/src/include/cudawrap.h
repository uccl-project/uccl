...
/* CUDA 13+ only exposes versioned PFN types (e.g. PFN_cuDeviceGet_v2000).
 * Use versioned declarations so we compile with CUDA 12 and 13. */
...
DECLARE_CUDA_PFN_EXTERN(cuCtxCreate, 4000);
