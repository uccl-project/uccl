...
// Compile: g++ -std=c++17 multiple_qp_example.cpp -o multiple_qp_example -libverbs -lefa
...
int main() {
    ...
    // 5. Create Completion Queues (one for send, one for recv - shared by all QPs)
    int cq_size = 128;
    ...
    printf("\nConclusion: YES, you can create multiple QPs and QP_EX under same context!\n");
    return 0;
}
