...
class ICompressorBackend {
 public:
   ...
   * @return true on success, false on failure.
   */
  virtual bool prepare_decompress(std::shared_ptr<RDMARecvRequest> req) = 0;
...
class NullCompressorBackend : public ICompressorBackend {
 public:
  ...
  bool prepare_decompress(std::shared_ptr<RDMARecvRequest> req) override;
...
class Compressor {
 public:
   ...
   * @return true on success, false on failure.
   */
  bool prepare_decompress(std::shared_ptr<RDMARecvRequest> req);
