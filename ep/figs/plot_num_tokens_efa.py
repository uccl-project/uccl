...
bf16_combine_lat = np.array([1992.00, 3355.00, 4164.00, 5478.00, np.nan])  # Added NaN to match 5 tokens
...
plt.plot(num_tokens, fp8_dispatch_rdma, marker="x", linestyle="--", label="FP8 Dispatch (RDMA)")
plt.plot(num_tokens, fp8_dispatch_nvl, marker="d", linestyle="--", label="FP8 Dispatch (NVLink)")
...
plt.plot(num_tokens, fp8_combine_rdma, marker="x", linestyle="--", label="FP8 Combine (RDMA)")
plt.plot(num_tokens, fp8_combine_nvl, marker="d", linestyle="--", label="FP8 Combine (NVLink)")
plt.xlabel("Number of Tokens")
